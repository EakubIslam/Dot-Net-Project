...
{
    /// <inheritdoc />
    public partial class CreateUsersAndCourseTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassSchedules", x => x.CourseId);
                });
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Discriminator", "Name", "Password", "Username" },
                values: new object[,]
                {
                    { -2, "Admin", "Eakub", "123456", "eakub" },
